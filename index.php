...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="676" style="background-color:#355BA9" align="center"><img src="img/login_banner.png" width="676" height="247"/></td><td style="background-color:#B6CFFF"><form class="form" name="form" method="post" action="v0001.php">	
...
<!-- -->
  ...
  <tr>
    ...
    <td class="fondo"><div align="left">
      <BUTTON  class="b" name=Submit 
type=submit><IMG alt=Login src="img/key.png">Ingresar</BUTTON> 
