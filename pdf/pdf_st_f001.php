...
$resultado_tkt = mysql_query("SELECT ticket,idnodo,estacion,fecha_inicio_rif,hora_inicio_rif,fecha_fin_rif,hora_fin_rif FROM st_ticket where ticket='$ticket';");
$dato_tkt = mysql_fetch_array($resultado_tkt);
...
,array('izq'=>'Estación: <b>'.$dato_t['ubicacion'].'</b>','der'=>'Centro de Mantenimiento: <b>'.$dato_t['departamento'].'</b>')
);
...
/*
$pdf->ezText("\n",5);
$data=array(array('izq'=>'<b>DAÑOS Y PARTES AFECTADAS EN LA ESTACIÓN</b>'));
$pdf->ezTable($data,'','',
array('xPos'=>'right',
'xOrientation'=>'left',
                'showHeadings'=>0,                
